...
class Ssp_jquery extends Ssp_javascript {

	var $_javascript_folder = '/wp-includes/js';
	...
	{
		$event = "\n\tjQuery(" . $this->_prep_element($element) . ").hover(\n\t\tfunction()\n\t\t{\n\t\t\t{$over}\n\t\t}, \n\t\tfunction()\n\t\t{\n\t\t\t{$out}\n\t\t});\n";
	...
	function _addClass($element = 'this', $class='')
	{
		...
		$str  = "jQuery({$element}).addClass(\"$class\");";
		return $str;
	}
	...
	function _fadeIn($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).fadeIn({$speed}{$callback});";
	...
	function _fadeOut($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).fadeOut({$speed}{$callback});";
	...
	function _hide($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).hide({$speed}{$callback});";
	...
	{
		$element = $this->_prep_element($element);
		$str  = "jQuery({$element}).removeClass(\"$class\");";
		return $str;
	}
	...
	function _slideUp($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).slideUp({$speed}{$callback});";
	...
	function _slideDown($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).slideDown({$speed}{$callback});";
	...
	function _slideToggle($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).slideToggle({$speed}{$callback});";
	...
	{
		$element = $this->_prep_element($element);
		$str  = "jQuery({$element}).toggleClass(\"$class\");";
		return $str;
	}
	...
	function _show($element = 'this', $speed = '', $callback = '')
	{
		...
		$str  = "jQuery({$element}).show({$speed}{$callback});";
	...
	{	
		...
		$updater = "jQuery($container).empty();\n"; // anything that was in... get it out
		$updater .= "\t\tjQuery($container).prepend(\"$loading_notifier\");\n"; // to replace with an image
		...
		$updater .= "\t\tjQuery($container).load('$controller'$request_options);";
		return $updater;
	}
	...
	function _zebraTables($class = '', $odd = 'odd', $hover = '')
	{
		...
		$zebra  = "\t\jQuery(\"table{$class} tbody tr:nth-child(even)\").addClass(\"{$odd}\");";

		$this->jquery_code_for_compile[] = $zebra;

		if ($hover != '')
		{
			$hover = $this->hover("table{$class} tbody tr", "jQuery(this).addClass('hover');", "jQuery(this).removeClass('hover');");
		}
	...
	function corner($element = '', $corner_style = '')
	{
		...
		return "jQuery(" . $this->_prep_element($element) . ").corner(".$corner_style.");";
	}
	...
	function sortable($element, $options = array())
	{
		...
		return "jQuery(" . $this->_prep_element($element) . ").sortable({".$sort_options."\n\t});";
	}
	...
	{
		$this->jquery_code_for_compile[] = "\tjQuery(" . $this->_prep_element($table) . ").tablesorter($options);\n";
	}
	...
	function _add_event($element, $js, $event)
	{
		...
		$event = "\n\tjQuery(" . $this->_prep_element($element) . ").{$event}(function(){\n\t\t{$js}\n\t});\n";
		$this->jquery_code_for_compile[] = $event;
		return $event;
	}
